...
- (void)viewDidLoad
{
    ...
    spName1Details = [[UILabel alloc] initWithFrame:CGRectMake(100.0f, 0.0f, 214.0f, 25.0f)];
    ...
    spName2Details = [[UILabel alloc] initWithFrame:CGRectMake(100.0f, 150.0f, 214.0f, 25.0f)];
    if (spName2Details != nil) {
        ...
        spName2Details.numberOfLines = 5;
    ...
    spName3Details = [[UILabel alloc] initWithFrame:CGRectMake(100.0f, 300.0f, 214.0f, 25.0f)];
